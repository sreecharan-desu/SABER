...
5. [Error Handling](#error-handling)w
...
**Endpoint:** `POST /api/recruiter/company`
...
**Endpoint:** `POST /api/recruiter/job`
...
**Endpoint:** `GET /api/recruiter/recruiter/feed`
...
**Endpoint:** `POST /api/recruiter/recruiter/swipe`
